        ...
        <div class="container">
            <div class="header-left">
                <div class="welcome-msg">
                    <a href="contact-us.html" class="contact"><i class="d-icon-map"></i>Find
                        Riode
                        Store</a>
            ...
            <div class="header-right">
                ...
                <div class="dropdown wishlist wishlist-dropdown off-canvas">
                 ...
                 <a href="#" class="login-link"><i class="d-icon-user"></i>Login</a>
                 <a href="{{url('user-register')}}" class="login-link"><i class="d-icon-plus"></i> Register</a>
        ...
        <div class="container">
            <div class="header-left">
                ...
                <a href="{{url('/')}}" class="logo d-none d-lg-block">
                    <img src="images/demos/demo32/logo.png" alt="logo" width="154" height="43" />
                </a>
                <!-- End Logo -->
            </div>
